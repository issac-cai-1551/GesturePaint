...
#
#             # 🔥 修改：在提示词中添加触发词 🔥
#             # 假设你的触发词是 "myschool_style"
#             trigger_word = "nanjing_university"
#
#             # 组合提示词：触发词 + 自动生成的描述 + 艺术风格
#             enhanced_prompt = f"{trigger_word}, {prompt}, {style}"
#
#             # 或者如果你想要更强调触发词：
#             # enhanced_prompt = f"{trigger_word}, {prompt}, {style}, masterpiece, best quality"
#
#             # 如果你发现触发词效果太强，可以调整权重：
#             # enhanced_prompt = f"({trigger_word}:1.1), {prompt}, {style}"
#
